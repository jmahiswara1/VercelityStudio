...
export const en: LocaleStrings = {
    ...
    'pricing.title': 'Price Packages.',
    'pricing.subtitle': 'Transparent pricing tailored to your needs. Let\'s discuss your project and find a plan that works for you.',

    'pricing.web.name': 'Web Development',
    'pricing.web.price': 'Web',
    'pricing.web.target': 'For businesses with existing designs.',
    'pricing.web.btn': 'Choose Package',
    'pricing.web.f1': 'Frontend Dev (React/Next.js)',
    'pricing.web.f2': 'CMS Integration',
    'pricing.web.f3': 'Performance Optimization',
    'pricing.web.f4': 'Fully Responsive',

    'pricing.design.name': 'UI/UX Design',
    'pricing.design.price': 'Design',
    'pricing.design.target': 'For startups needing interactive design.',
    'pricing.design.btn': 'Choose Package',
    'pricing.design.f1': 'Wireframing & Prototyping',
    'pricing.design.f2': 'High-Res UI Design (Figma)',
    'pricing.design.f3': 'Design System',
    'pricing.design.f4': 'Graphic & SVG Assets',

    'pricing.full.name': 'Full Package',
    'pricing.full.badge': 'Most Popular',
    'pricing.full.price': 'Best Value',
    'pricing.full.target': 'Complete digital solution from zero to launch.',
    'pricing.full.btn': 'Choose Package',
    'pricing.full.f1': 'All UI/UX Features',
    'pricing.full.f2': 'All Web Dev Features',
    'pricing.full.f3': 'Advanced Animations',
