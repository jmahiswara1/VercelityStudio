...
export const id: LocaleStrings = {
    ...
    'pricing.subtitle': 'Harga transparan yang disesuaikan dengan kebutuhan Anda. Mari diskusikan proyek Anda.',

    'pricing.web.name': 'Pengembangan Web',
    'pricing.web.price': 'Web',
    'pricing.web.target': 'Untuk bisnis yang sudah memiliki desain jadi.',
    'pricing.web.btn': 'Pilih Paket',
    'pricing.web.f1': 'Frontend Dev (React/Next.js)',
    'pricing.web.f2': 'CMS Terintegrasi',
    'pricing.web.f3': 'Optimasi Performa',
    'pricing.web.f4': 'Responsif Semua Perangkat',

    'pricing.design.name': 'Desain UI/UX',
    'pricing.design.price': 'Design',
    'pricing.design.target': 'Untuk startup yang butuh desain interaktif.',
    'pricing.design.btn': 'Pilih Paket',
    'pricing.design.f1': 'Wireframing & Prototyping',
    'pricing.design.f2': 'Desain UI Resolusi Tinggi',
    'pricing.design.f3': 'Sistem Desain (Design System)',
    'pricing.design.f4': 'Aset Grafis & SVG',

    'pricing.full.name': 'Paket Lengkap',
    'pricing.full.badge': 'Paling Diminati',
    'pricing.full.price': 'Best Value',
    'pricing.full.target': 'Solusi digital komplet dari nol sampai rilis.',
    'pricing.full.btn': 'Pilih Paket',
    'pricing.full.f1': 'Semua Fitur UI/UX',
    'pricing.full.f2': 'Semua Fitur Web Dev',
    'pricing.full.f3': 'Animasi Lanjutan',
